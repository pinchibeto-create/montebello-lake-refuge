...
function BotSimulator(){
 ...
 return <main style={{minHeight:"100vh",background:"#f4f1e8",padding:"28px 16px",color:"#173326",fontFamily:"system-ui,sans-serif"}}><div style={{maxWidth:1180,margin:"0 auto"}}>
  <header style={{marginBottom:20}}><div style={{display:"flex",justifyContent:"space-between",gap:12,alignItems:"flex-start",flexWrap:"wrap"}}><div><div style={{fontSize:13,fontWeight:800,letterSpacing:1.5}}>CINCO LAGOS · LABORATORIO</div><h1 style={{fontSize:34,margin:"6px 0"}}>Simulador del recepcionista IA</h1><p style={{margin:0,opacity:.72}}>Usa OpenAI + reglas + ejemplos reales + disponibilidad y tarifas de Supabase. Conserva el historial reciente y no envía mensajes a huéspedes.</p></div><a href="/modo-sombra" style={{display:"inline-block",background:"#173326",color:"white",padding:"10px 14px",borderRadius:12,textDecoration:"none",fontWeight:800,fontSize:13}}>Abrir modo sombra →</a></div></header>
